...
```clojure
com.github.seancorfield/logging4j2 {:mvn/version "1.0.7"}
```

This version of the library depends on log4j2 2.25.4, which is the
latest stable release as of March 2026.
